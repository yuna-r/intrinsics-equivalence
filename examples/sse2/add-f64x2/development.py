"""Development generator and executable model for _mm_add_pd."""
...
def candidates(
    ...
    structured = (
        (
            (0x3FF0000000000000, 0x4024000000000000),
            (0x4000000000000000, 0x4034000000000000),
            "structured",
        ),
        ...
        (
            (0x3FF0000000000000, 0x3FF0000000000000),
            (0x3CA8000000000000, 0x3CA8000000000000),
            "boundary",
        ),
        (
