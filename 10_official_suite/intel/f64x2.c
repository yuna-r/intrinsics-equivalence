...
IOITF_BINARY(f64x2, f64x2, intel_andnot_f64x2, _mm_andnot_pd(a, b))
...
IOITF_BINARY(int, f64x2, intel_comigt_f64x2, _mm_comigt_sd(a, b))
IOITF_BINARY(int, f64x2, intel_comige_f64x2, _mm_comige_sd(a, b))
