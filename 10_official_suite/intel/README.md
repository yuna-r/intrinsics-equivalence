...
<p>
  ...
  <img alt="128 operations" src="https://img.shields.io/badge/operations-128-7c4dff?style=flat">
</p>

OpenPOWER側と同じ全128ケースを、Intel SSE2 Intrinsicsで型ごとの塊にまとめています。
...
| Block | Cases | Source |
|---|---:|---|
| f32/f64/i32 bit cast | 4 | [`f32x4.c`](f32x4.c) |
| f64 arithmetic / bit / construct / lane / compare | 36 | [`f64x2.c`](f64x2.c) |
