...
IOITF_BINARY(u16x8, u16x8, power_adds_u16x8, vec_adds(a, b))
IOITF_BINARY(u16x8, u16x8, power_subs_i16x8, (u16x8)vec_subs((i16x8)a, (i16x8)b))
IOITF_BINARY(u16x8, u16x8, power_subs_u16x8, vec_subs(a, b))
IOITF_BINARY(u16x8, u16x8, power_cmpeq_i16x8, (u16x8)vec_cmpeq(a, b))
IOITF_BINARY(u16x8, u16x8, power_cmpgt_i16x8, (u16x8)vec_cmpgt((i16x8)a, (i16x8)b))
IOITF_BINARY(i16x8, i16x8, power_mullo_i16x8, (i16x8)((u16x8)a * (u16x8)b))
...
IOITF_BINARY(static unsigned short, unsigned short, unsigned_mul_high, (unsigned short)(((unsigned)a * (unsigned)b) >> 16))
...
IOITF_BINARY(i32x4, i16x8, power_madd_i16x8, vec_msum(a, b, vec_splats(0)))
IOITF_BINARY(u16x8, u16x8, power_avg_u16x8, vec_avg(a, b))
IOITF_BINARY(i16x8, i16x8, power_min_i16x8, vec_min(a, b))
IOITF_BINARY(i16x8, i16x8, power_max_i16x8, vec_max(a, b))
...
IOITF_BINARY(i16x8, i16x8, power_unpacklo_i16x8, (i16x8){a[0], b[0], a[1], b[1], a[2], b[2], a[3], b[3]})
IOITF_BINARY(i16x8, i16x8, power_unpackhi_i16x8, (i16x8){a[4], b[4], a[5], b[5], a[6], b[6], a[7], b[7]})
IOITF_BINARY(i8x16, i16x8, power_packs_i16x8, vec_packs(a, b))
IOITF_BINARY(u8x16, i16x8, power_packus_i16x8, vec_packsu(a, b))
...
IOITF_BINARY(u16x8, u16x8, power_cmplt_i16x8, (u16x8)vec_cmpgt((i16x8)b, (i16x8)a))
