"""Development generator and executable model for _mm_mul_pd."""
...
CASE_ID = "sse2.mul.f64x2.default"
...
def candidates(
    ...
    structured = (
        ((0x4000000000000000, 0xC008000000000000),
         (0x4010000000000000, 0x3FE0000000000000), "structured"),
        ((0, 0x8000000000000000),
         (0xBFF0000000000000, 0xBFF0000000000000), "boundary"),
        ((0x0000000000000001, 0x8000000000000001),
         (0x3FF0000000000000, 0x3FF0000000000000), "boundary"),
        ((0x0010000000000000, 0x8010000000000000),
         (0x3FE0000000000000, 0x3FE0000000000000), "boundary"),
        ...
        ((0x7FF8000000000001, 0x7FF0000000000001),
         (0x3FF0000000000000, 0x3FF0000000000000), "boundary"),
        ((0x7FEFFFFFFFFFFFFF, 0xFFEFFFFFFFFFFFFF),
         (0x4000000000000000, 0x4000000000000000), "boundary"),
        ((0x3FF0000000000001, 0xBFF0000000000001),
         (0x3FEFFFFFFFFFFFFF, 0x3FEFFFFFFFFFFFFF), "boundary"),
    )
