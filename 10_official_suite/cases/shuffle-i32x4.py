"""Case pack for _mm_shuffle_epi32."""

CASE_YAML = """
schema_version: 1
id: sse2.shuffle.i32x4.imm8
description: shuffle four signed 32-bit lanes using an imm8 control
...
CASE_ID, MINIMUM_COUNTS, candidates, execute = shuffle_case("sse2.shuffle.i32x4.imm8", "i32x4", "all")
