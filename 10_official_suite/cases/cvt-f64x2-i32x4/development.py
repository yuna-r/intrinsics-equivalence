"""Development generator and executable model for _mm_cvtpd_epi32."""
...
def candidates(
    ...
    structured = (
        ...
        (0x3FF6666666666666, 0xBFF6666666666666),
...
def execute(record: dict[str, JSONValue]) -> dict[str, JSONValue]:
    ...
    converted = tuple(_nearest_i32(int(str(bits), 16)) for bits in lanes)
