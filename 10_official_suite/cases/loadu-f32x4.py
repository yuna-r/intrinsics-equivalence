"""Case pack for _mm_loadu_ps."""

CASE_YAML = """
schema_version: 1
id: sse2.loadu.f32x4.default
description: unaligned 16-byte load into four binary32 lanes

intel:
  symbol: intel_mm_loadu_ps
  required_isa: [sse2]

openpower:
  symbol: power_mm_loadu_ps
...
CASE_ID, MINIMUM_COUNTS, candidates, execute = memory_load_case(
    "sse2.loadu.f32x4.default", "f32x4", "all"
)
