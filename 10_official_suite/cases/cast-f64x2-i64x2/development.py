"""Development generator and executable model for _mm_castpd_si128."""
...
def execute(record: dict[str, JSONValue]) -> dict[str, JSONValue]:
    ...
    return {"return": {"element": "i64", "lanes": [str(lane) for lane in lanes]}}
