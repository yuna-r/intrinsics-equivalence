"""Case pack for _mm_storeu_si128."""

CASE_YAML = """
schema_version: 1
id: sse2.storeu.i32x4.default
description: store four signed 32-bit lanes to unaligned memory in lane order

intel:
  symbol: intel_mm_storeu_si128
  required_isa: [sse2]

openpower:
  symbol: power_mm_storeu_si128
...
CASE_ID, MINIMUM_COUNTS, candidates, execute = memory_store_case(
    "sse2.storeu.i32x4.default", "i32x4", "all"
)
