"""Case pack for _mm_srl_epi16."""

CASE_YAML = """
schema_version: 1
id: sse2.srl.i16x8.vector-count
description: logical right shift using the low 64-bit lane of a vector count

intel:
  symbol: intel_mm_srl_epi16
  required_isa: [sse2]

openpower:
  symbol: power_mm_srl_epi16
...
CASE_ID, MINIMUM_COUNTS, candidates, execute = variable_shift_case("sse2.srl.i16x8.vector-count", "i16", 8, "logical-right")
