"""Case pack for _mm_max_pd."""

CASE_YAML = """
schema_version: 1
id: sse2.max.f64x2.default
description: packed binary64 maximum with SSE2 NaN and signed-zero selection semantics

intel:
  symbol: intel_mm_max_pd
  required_isa: [sse2]

openpower:
  symbol: power_mm_max_pd
