"""Case pack for _mm_comile_ss."""

CASE_YAML = """
schema_version: 1
id: sse2.comile.f32x4.scalar
description: compare low binary32 lanes for ordered less-or-equal and return a scalar flag

intel:
  symbol: intel_mm_comile_ss
  required_isa: [sse2]

openpower:
  symbol: power_mm_comile_ss
