"""Case pack for _mm_setr_epi32."""

CASE_YAML = """
schema_version: 1
id: sse2.setr.i32x4.low-high
description: construct four signed 32-bit lanes supplied low to high

intel:
  symbol: intel_mm_setr_epi32
  required_isa: [sse2]

openpower:
  symbol: power_mm_setr_epi32
