"""Case pack for _mm_comige_sd."""

CASE_YAML = """
schema_version: 1
id: sse2.comige.f64x2.scalar
description: scalar ordered/unordered binary64 comparison of the low lanes

intel:
  symbol: intel_mm_comige_sd
  required_isa: [sse2]

openpower:
  symbol: power_mm_comige_sd
...
CASE_ID, MINIMUM_COUNTS, candidates, execute = comi_f64_case("sse2.comige.f64x2.scalar", "ge")
