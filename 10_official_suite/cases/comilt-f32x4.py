"""Case pack for _mm_comilt_ss."""

CASE_YAML = """
schema_version: 1
id: sse2.comilt.f32x4.scalar
description: compare low binary32 lanes for ordered less-than and return a scalar flag

intel:
  symbol: intel_mm_comilt_ss
  required_isa: [sse2]

openpower:
  symbol: power_mm_comilt_ss
