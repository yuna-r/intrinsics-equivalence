"""Development generator and executable model for _mm_or_pd."""
...
def candidates(
    ...
    structured = (
        ...
        ((0x7FF8000000000042, 0xFFF0000000000000),
         (0x0007FFFFFFFFFFBD, 0x000FFFFFFFFFFFFF)),
        ...
        ((0x7FEFFFFFFFFFFFFF, 0x0010000000000000),
         (0x8000000000000000, 0xFFEFFFFFFFFFFFFF)),
    )
