"""Development generator and executable model for _mm_cvttps_epi32."""
...
def candidates(
    ...
    structured = (
        ...
        (0x3FF33333, 0xBFF33333, 0x3FC00000, 0x40200000),
...
def execute(record: dict[str, JSONValue]) -> dict[str, JSONValue]:
    ...
    return {
        "return": vector(
            "i32", tuple(_truncate_i32(int(str(bits), 16)) for bits in lanes)
        )
    }
