"""Case pack for _mm_comige_ss."""

CASE_YAML = """
schema_version: 1
id: sse2.comige.f32x4.scalar
description: compare low binary32 lanes for ordered greater-or-equal and return a scalar flag

intel:
  symbol: intel_mm_comige_ss
  required_isa: [sse2]

openpower:
  symbol: power_mm_comige_ss
