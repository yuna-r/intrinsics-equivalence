"""Case pack for _mm_castsi128_ps."""

CASE_YAML = """
schema_version: 1
id: sse2.cast.i32x4.f32x4
description: reinterpret the full 128-bit payload from i32 lanes to f32 lanes

intel:
  symbol: intel_mm_castsi128_ps
  required_isa: [sse2]

openpower:
  symbol: power_mm_castsi128_ps
