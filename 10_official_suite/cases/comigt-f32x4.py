"""Case pack for _mm_comigt_ss."""

CASE_YAML = """
schema_version: 1
id: sse2.comigt.f32x4.scalar
description: compare low binary32 lanes for ordered greater-than and return a scalar flag

intel:
  symbol: intel_mm_comigt_ss
  required_isa: [sse2]

openpower:
  symbol: power_mm_comigt_ss
